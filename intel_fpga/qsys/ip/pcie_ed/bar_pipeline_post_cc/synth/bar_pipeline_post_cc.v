// bar_pipeline_post_cc.v

// Generated using ACDS version 25.1 129

`timescale 1 ps / 1 ps
module bar_pipeline_post_cc #(
		...
		input  wire [127:0]                s0_byteenable,    //      .byteenable,    Indicates valid read/write data location
		...
		output wire [127:0]                m0_byteenable,    //      .byteenable,    Indicates valid read/write data location
		output wire                        m0_debugaccess    //      .debugaccess
	);

	bar_pipeline_post_cc_altera_avalon_mm_bridge_2010_tex5a4i #(
		...
		.s0_byteenable         (s0_byteenable),    //   input,               width = 128,      .byteenable
		...
		.m0_byteenable         (m0_byteenable),    //  output,               width = 128,      .byteenable
