...
#    * The helper routines are defined in user_clk_pll_altera_iopll_2000_d7s7bfy_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/user_clk_pll_altera_iopll_2000_d7s7bfy_parameters.tcl"
source "$script_dir/user_clk_pll_altera_iopll_2000_d7s7bfy_pin_map.tcl"
...
if {[info exists ::GLOBAL_top_user_clk_pll_altera_iopll_2000_d7s7bfy_corename_ai_pll_db]} {
    # Clean-up stale content
    unset ::GLOBAL_top_user_clk_pll_altera_iopll_2000_d7s7bfy_corename_ai_pll_db
}
if {[catch {ai_initialize_pll_db ::GLOBAL_top_user_clk_pll_altera_iopll_2000_d7s7bfy_corename_ai_pll_db} err_initializing_db]} {
...
# following loop
set instances [ array names ::GLOBAL_top_user_clk_pll_altera_iopll_2000_d7s7bfy_corename_ai_pll_db ]
foreach { inst } $instances {
    ...
    lassign $::GLOBAL_top_user_clk_pll_altera_iopll_2000_d7s7bfy_corename_ai_pll_db($inst) base_clock_data_dict gen_clock_data_dict
